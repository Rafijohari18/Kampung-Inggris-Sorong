                            ...
                            <div class="card-body pb-2">
                                ...
                                <div class="form-group row" id="file">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <span class="text-muted">Type of file : <strong>{{ config('custom.mimes.gallery_photo.m') }}</strong>, Pixel : <strong>{{ config('custom.mimes.gallery_photo.p') }}</strong></span>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control mb-1 @error('alt') is-invalid @enderror" name="alt" value="{{ old('alt') }}" placeholder="Enter photo alt...">
