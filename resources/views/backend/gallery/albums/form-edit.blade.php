                          ...
                          <div class="tab-pane fade {{ ($loop->first) ? 'active show' : '' }}" id="{{ $lang->iso_codes }}">
                            <div class="card-body pb-2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control mb-1 gen_slug @error('name_'.$lang->iso_codes) is-invalid @enderror"
                                            lang="{{ $lang->iso_codes }}" name="name_{{ $lang->iso_codes }}" value="{{ old('name_'.$lang->iso_codes, $data['album']->fieldLang('name')) }}" placeholder="Enter name...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control tiny-mce" name="description_{{ $lang->iso_codes }}">{!! old('description_'.$lang->iso_codes, $data['album']->fieldLang('description')) !!}</textarea>
                                    </div>
                                </div>
                            </div>
                          </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="custom-control custom-checkbox m-0">
                                    <input type="checkbox" class="custom-control-input" name="is_widget" value="1" {{ old('is_widget', $data['album']->is_widget) ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control mb-1 @error('list_limit') is-invalid @enderror" name="list_limit"
                                        value="{{ old('list_limit', $data['album']->list_limit) }}" placeholder="Enter limit...">
