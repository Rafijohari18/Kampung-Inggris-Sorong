...
<div class="card">
    <div class="list-group list-group-flush account-settings-links flex-row">
        ...
        @if ($data['catalog_product']->field->count() > 0)
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#field">Addon Field</a>
        @endif
    </div>
    <div class="card-body">
        <form action="{{ route('catalog.product.update', ['categoryId' => $data['catalog_product']->catalog_category_id, 'id' => $data['catalog_product']->id]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="tab-content">
                          ...
                          <div class="tab-pane fade {{ ($loop->first) ? 'active show' : '' }}" id="{{ $lang->iso_codes }}">
                            <div class="card-body pb-2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control mb-1 gen_slug @error('title_'.$lang->iso_codes) is-invalid @enderror"
                                            lang="{{ $lang->iso_codes }}" name="title_{{ $lang->iso_codes }}" value="{{ old('title_'.$lang->iso_codes, $data['catalog_product']->fieldLang('title')) }}" placeholder="Enter title...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control mb-1 slug_spot @error('slug') is-invalid @enderror" lang="{{ $lang->iso_codes }}" name="slug"
                                                value="{{ old('slug', $data['catalog_product']->slug) }}" placeholder="Enter slug...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control tiny-mce" name="intro_{{ $lang->iso_codes }}">{!! old('intro_'.$lang->iso_codes, $data['catalog_product']->fieldLang('intro')) !!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-2 text-sm-right">Content</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control tiny-mce" name="content_{{ $lang->iso_codes }}">{!! old('content_'.$lang->iso_codes, $data['catalog_product']->fieldLang('content')) !!}</textarea>
                                    </div>
                                </div>
                            </div>
                          </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control mb-1 @error('quantity') is-invalid @enderror" name="quantity"
                                    value="{{ old('quantity', $data['catalog_product']->quntity) }}" placeholder="Enter quantity...">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control mb-1 @error('price') is-invalid @enderror" id="price" name="price" onkeyup="document.getElementById('format').innerHTML = formatCurrency(this.value);" autocomplete="off"
                                    value="{{ old('price', $data['catalog_product']->price) }}" placeholder="Enter price...">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="switcher">
                                    <input type="checkbox" name="is_discount" id="is-discount" value="{{ old('is_discount', $data['catalog_product']->is_discount) ? 'checked' : '' }}" class="switcher-input">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="number" class="form-control @error('discount') is-invalid @enderror" name="discount" max="100"
                                        value="{{ old('discount', $data['catalog_product']->discount) }}" placeholder="Enter discount...">
                ...
                <div class="tab-pane fade" id="setting">
                    <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" name="publish" data-style="btn-default">
                                    @foreach (config('custom.label.publish') as $key => $publish)
                                        <option value="{{ $key }}" {{ (old('publish') == ''.$key.'') == $data['catalog_product']->publish ? 'selected' : '' }}>
                                            {{ $publish['title'] }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" class="datetime-picker form-control @error('created_at') is-invalid @enderror" name="created_at"
                                        value="{{ old('created_at', $data['catalog_product']->created_at) }}" placeholder="enter publish time...">
                                    <div class="input-group-append">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="custom-control custom-checkbox m-0">
                                    <input type="checkbox" class="custom-control-input" name="public" value="1" {{ old('public', $data['catalog_product']->public) ? 'checked' : 'checked' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="custom-control custom-checkbox m-0">
                                    <input type="checkbox" class="custom-control-input" name="is_widget" value="1" {{ old('is_widget', $data['catalog_product']->is_widget) ? 'checked' : '' }}>
                                    <span class="custom-control-label ml-4">YES</span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" class="form-control @error('cover_file') is-invalid @enderror" id="image1" aria-label="Image" aria-describedby="button-image" name="cover_file"
                                            value="{{ old('cover_file', $data['catalog_product']->cover['file_path']) }}" placeholder="browse cover..." readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="title..." name="cover_title" value="{{ old('cover_title', $data['catalog_product']->cover['title']) }}">
                                    </div>
                                    <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="alt..." name="cover_alt" value="{{ old('cover_alt', $data['catalog_product']->cover['alt']) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="image2" aria-label="Image2" aria-describedby="button-image2" name="banner_file"
                                            value="{{ old('banner_file', $data['catalog_product']->banner['file_path']) }}" placeholder="browse banner..." readonly>
                                    <div class="input-group-append" title="browse file">
                                        <span class="input-group-text">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="title..." name="banner_title" value="{{ old('banner_title', $data['catalog_product']->banner['title']) }}">
                                    </div>
                                    <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="alt..." name="banner_alt" value="{{ old('banner_alt', $data['catalog_product']->banner['alt']) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" name="custom_view_id" data-style="btn-default">
                                    ...
                                    @foreach ($data['template'] as $custom)
                                        <option value="{{ $custom->id }}" {{ (old('custom_view_id', $data['catalog_product']->custom_view_id) == $custom->id) ? 'selected' : '' }}>
                                            {{ $custom->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-10">
                                <div class="select2-primary">
                                    <select class="select2 form-control" name="tags[]" multiple style="width: 100%">
                                        ...
                                        <option value="{{ $tag->id }}" {{ (in_array($tag->id, $data['tags_id'])) ? 'selected' : '' }}>
                                            {{ $tag->name }}
                                            @if ($tag->standar == 1)
                                            (standar)
                                            @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control mb-1" name="meta_title" value="{{ old('meta_title', $data['catalog_product']->meta_data['title']) }}" placeholder="Enter meta title...">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Meta Description</label>
                            <div class="col-sm-10">
                                <textarea class="form-control mb-1" name="meta_description" placeholder="Separated by comma (,)">{{ old('meta_decsription', $data['catalog_product']->meta_data['description']) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Meta Keywords</label>
                            <div class="col-sm-10">
                                <textarea class="form-control mb-1" name="meta_keywords" placeholder="Separated by comma (,)">{{ old('meta_keywords', $data['catalog_product']->keywords) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="field">
                    <div class="card-body">
                        @foreach ($data['catalog_product']->field as $field)
                        @include('backend.master.field.input', ['module' => 'catalog_product'])
                        @endforeach
                    </div>
                </div>
                @endif
