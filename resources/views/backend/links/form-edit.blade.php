                          ...
                          <div class="tab-pane fade {{ ($loop->first) ? 'active show' : '' }}" id="{{ $lang->iso_codes }}">
                            <div class="card-body pb-2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control mb-1 gen_slug @error('name_'.$lang->iso_codes) is-invalid @enderror"
                                            lang="{{ $lang->iso_codes }}" name="name_{{ $lang->iso_codes }}" value="{{ old('name_'.$lang->iso_codes, $data['link']->fieldLang('name')) }}" placeholder="Enter name...">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control tiny-mce" name="description_{{ $lang->iso_codes }}">{!! old('description_'.$lang->iso_codes, $data['link']->fieldLang('description')) !!}</textarea>
                                    </div>
                                </div>
                            </div>
                          </div>
                ...
                <div class="tab-pane fade" id="setting">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="custom-control custom-checkbox m-0">
                                    <input type="checkbox" class="custom-control-input" name="is_widget" value="1" {{ old('is_widget', $data['link']->is_widget) ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control mb-1 @error('list_limit') is-invalid @enderror" name="list_limit"
                                        value="{{ old('list_limit', $data['link']->list_limit) }}" placeholder="Enter limit...">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control mb-1" name="meta_title" value="{{ old('meta_title', $data['link']->meta_data['title']) }}" placeholder="Enter meta title...">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Meta Description</label>
                            <div class="col-sm-10">
                                <textarea class="form-control mb-1" name="meta_description" placeholder="Separated by comma (,)">{{ old('meta_decsription', $data['link']->meta_data['description']) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">Meta Keywords</label>
                            <div class="col-sm-10">
                                <textarea class="form-control mb-1" name="meta_keywords" placeholder="Separated by comma (,)">{{ old('meta_keywords', $data['link']->meta_data['keywords']) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                @if ($data['link']->field->count())
                <div class="tab-pane fade" id="field">
                    <div class="card-body">
                        @foreach ($data['link']->field as $field)
                        @include('backend.master.field.input', ['module' => 'link'])
                        @endforeach
                    </div>
                </div>
                @endif
