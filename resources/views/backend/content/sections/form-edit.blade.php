        ...
        <form action="{{ route('section.update', ['id' => $data['section']->id]) }}" method="POST">
            ...
            <div class="tab-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control mb-1 gen_slug @error('name_'.$lang->iso_codes) is-invalid @enderror"
                                            lang="{{ $lang->iso_codes }}" name="name_{{ $lang->iso_codes }}" value="{{ old('name_'.$lang->iso_codes, $data['section']->fieldLang('name', $lang->iso_codes)) }}" placeholder="Enter name...">
                ...
                <div class="tab-pane fade" id="setting">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="custom-control custom-checkbox m-0">
                                    <input type="checkbox" class="custom-control-input" name="cover_required" value="1" {{ old('cover_required', $data['section']->cover_required )? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="custom-control custom-checkbox m-0">
                                    <input type="checkbox" class="custom-control-input" name="public" value="1" {{ old('public', $data['section']->public) ? 'checked' : 'checked' }}>
                                    <span class="custom-control-label ml-4">YES</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="custom-control custom-checkbox m-0">
                                    <input type="checkbox" class="custom-control-input" name="is_widget" value="1" {{ old('is_widget', $data['section']->is_widget) ? 'checked' : '' }}>
                                    <span class="custom-control-label ml-4">YES</span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" name="list_view_id" data-style="btn-default">
                                    ...
                                    @foreach ($data['template_list'] as $custom_list)
                                        <option value="{{ $custom_list->id }}" {{ (old('list_view_id', $data['section']->list_view_id) == $custom_list->id) ? 'selected' : '' }}>
                                            {{ $custom_list->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" name="detail_view_id" data-style="btn-default">
                                    ...
                                    @foreach ($data['template_detail'] as $custom_detail)
                                        <option value="{{ $custom_detail->id }}" {{ (old('detail_view_id', $data['section']->detail_view_id) == $custom_detail->id) ? 'selected' : '' }}>
                                            {{ $custom_detail->name }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="tab-pane fade" id="field">
                    <div class="card-body">
                        @foreach ($data['section']->field as $field)
                        @include('backend.master.field.input', ['module' => 'section'])
                        @endforeach
                    </div>
                </div>
                @endif
