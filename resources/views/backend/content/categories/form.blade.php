    ...
    <div class="card-body">
        <form action="{{ route('category.store', ['sectionId' => $data['section']->id]) }}" method="POST">
                ...
                <div class="tab-pane fade" id="setting">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="list_limit" value="{{ old('list_limit') }}" placeholder="for posts">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-center">
                <a href="{{ route('category.index', ['sectionId' => $data['section']->id]) }}" class="btn btn-secondary" title="Cancel">Cancel</a>&nbsp;&nbsp;
