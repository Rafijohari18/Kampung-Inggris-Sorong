            ...
            <div class="col-lg-9 col-md-9">
                <div class="row gallery">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                        <div class="gallery-item" data-src="{{ $photo->photoSrc($photo) }}" title="{!! $photo->fieldLang('title') !!}" alt="{{ $photo->alt }}">
                            <div class="box-img">
                                <div class="thumb">
                                    <img class="lazy" data-src="{{ $photo->photoSrc($photo) }}" title="{!! $photo->fieldLang('title') !!}" alt="{{ $photo->alt }}">
                                </div>
                                <div class="overlay">
